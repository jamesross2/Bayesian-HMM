...
class Chain:
    ...
    def neglogp_chain(self, p_initial: InitDict, p_emission: NestedInitDict, p_transition: NestedInitDict) -> Numeric: ...
    @staticmethod
    def resample_latent_sequence(sequences: Tuple[List[str], List[str]], states: Set[str], p_initial: InitDict, p_emission: NestedInitDict, p_transition: NestedInitDict) -> List[str]: ...
