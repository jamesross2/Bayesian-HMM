...
def resample_latent_sequence(sequences: typing.Tuple[typing.List[bayesian_model.State], typing.List[bayesian_model.State]], states: typing.Set[bayesian_model.State], emission_probabilities: NestedInitDict, transition_probabilities: NestedInitDict) -> typing.List[bayesian_model.State]: ...
